...
public class ColorMap {
    ...
    public static void InitialColorMap() {
        colorMap.put(2, new Color(255, 0, 0)); // 红色
        colorMap.put(4, new Color(255, 140, 0)); // 橙色
        colorMap.put(8, new Color(255, 255, 0)); // 黄色
        colorMap.put(16, new Color(0, 255, 0)); // 绿色
        colorMap.put(32, new Color(0, 255, 255)); // 青色
        ...
        colorMap.put(2048, new Color(255, 69, 0)); // 橙红色
    }
